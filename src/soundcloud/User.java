...
public class User extends Account
{
    ...
    public User(String name, String email, String mobile_number, String password, String blocked_until, ArrayList <User> foll) {
        super(name, email, mobile_number, password, blocked_until);
        this.following=foll;
    }
...
//        ArrayList<SubscriptionPackages> packages = submanager.BrowsePackage(this);
    ...
    {
        this.following = conn.getFollowers(conn.getUserID(this));
    }
}